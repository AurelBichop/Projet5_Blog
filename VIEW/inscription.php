...
<div class="container mb-4">
    ...
    <form action="./?action=newinscription" method="post">
        <div class="form-group">
            ...
            <div class="form-group">
                <label>Prénom</label> *
                <input type="text" id="prenom" name="prenom" value="<?php if(isset($_POST['prenom'])){ echo $_POST['prenom']; } ?>" class="form-control" placeholder="Votre prénom">
        ...
        <div class="form-group">
            ...
            <input type="password" id="verif" name="verif" value="" class="form-control" placeholder="Entrez à nouveau votre mot de passe">
        </div>
            <div class="form-group">
